...
(def rsa-key-json '{
  :value (
    ...
    {:value "65537" :type :integer}
    {:value "" :type :integer}
    {:value "12753562913580676002895259500271898402544206790667077393749423242101594856648247715054754403773897078848798557211533428185806832271184534593610270414630437" :type :integer}
    {:value "12555712203890595143785953649835791209355238040885108486586460178610354944973062521923553540271133019963216268396997582478915551886885508674180820622666853" :type :integer}
